...
import 'package:recipes_ui_module/features/recipes/recipes_layout.dart';
import 'package:recipes_ui_module/features/recipes/views/pages/recipe_page.dart';
import 'package:recipes_ui_module/features/recipes/views/widgets/recipe_image.dart';
import 'package:recipes_ui_module/features/recipes/views/widgets/recipe_list_item_gesture_detector.dart';
import 'package:recipes_ui_module/features/recipes/views/widgets/recipe_list_item_image_wrapper.dart';
import 'package:recipes_ui_module/features/recipes/views/widgets/recipe_list_item_text.dart';
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: AppColors.orangeDark.withOpacity(
                          AppColors.getBrightness(widget.recipe.bgColor) == Brightness.dark ? 0.5 : 0.2,
                        ),
                        blurRadius: 10,
