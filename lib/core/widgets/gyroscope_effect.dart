...
import 'package:recipes_ui_module/features/recipes/providers/gyroscope_provider.dart';
    ...
    if (defaultTargetPlatform == TargetPlatform.macOS || defaultTargetPlatform == TargetPlatform.linux) {
      ...
      return Consumer(
        ...
        builder: (context, ref, child) {
          final GyroscopeEvent? gyroscopeEvent = ref.watch(gyroscopeProvider).value;
