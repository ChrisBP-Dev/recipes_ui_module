...
import 'package:recipes_ui_module/core/styles/app_text_styles.dart';
...
class AppThemes {
  static ThemeData main({bool isDark = false}) {
    return ThemeData(
      ...
      shadowColor: isDark ? AppColors.realBlack.withOpacity(0.4) : AppColors.black.withOpacity(0.2),
